<template>
    <div>
        <div class="backgroundImage"
             style="background-image: url(https://i2.wp.com/assets.yellowtrace.com.au/wp-content/uploads/2018/08/Noma-Restaurant-Copenhagen-by-Studio-Thulstrup-Yellowtrace-17.jpg)">
        </div>
        <div class="home">
